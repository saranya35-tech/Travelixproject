                                ...
                                <div className="row">
                                    <div className="col-md-12 nav-link-wrap">
                                        <div className="nav nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            ...
                                            <a className={filterType ? "nav-link" : "nav-link active mr-md-1" } id="v-pills-2-tab" onClick={() => ChangeSearchFilter(true)} >Hotel</a>

                                            <a className={filterType ? "nav-link active mr-md-1" : "nav-link" } id="v-pills-1-tab" onClick={() => ChangeSearchFilter(false)} >Search Tour</a>
                        ...
                        <div className="col-md-6 order-md-last heading-section pl-md-5 d-flex align-items-center">
                            <div className="w-100">
                                ...
                                {/* <p><a href="#" className="btn btn-primary py-3 px-4">Search Destination</a></p> */}
                                 <Link to="/destination#form-field" className="btn btn-primary py-3 px-4">
                                        Search Destination
                                </Link>
                            </div> 
                        </div>
                    ...
                    <div className="row">
                            ...
                            <div className="item">
                                <div className="project-destination">
                                    <a href="#" className="img"
                                        style={{ "backgroundImage": `url(${require('../images/place-1.jpg')})` }}>
                                        <div className="text">
                                            <h3>Philippines</h3>
                                            <span>8 Tours</span>
                                        </div>
                        ...
                        <div className="col-md-4 m-btm-40">
                            <div className="item">
                                <div className="project-destination">
                                    <a href="#" className="img"
                                        style={{ "backgroundImage": `url(${require('../images/place-2.jpg')})` }}>
                                        <div className="text">
                                            <h3>Canada</h3>
                                            <span>2 Tours</span>
                                        </div>
                        ...
                        <div className="col-md-4 m-btm-40">
                            <div className="item">
                                <div className="project-destination">
                                    <a href="#" className="img"
                                        style={{ "backgroundImage": `url(${require('../images/place-3.jpg')})` }}>
                                        <div className="text">
                                            <h3>Thailand</h3>
                                            <span>5 Tours</span>
                                        </div>
