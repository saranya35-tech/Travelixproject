                    ...
                    <div className="col-lg d-flex">
                        <div className="form-group p-4 border-0">
                            ...
                            <div className="form-field">
                                ...
                                <input type="text" className="form-control" placeholder="Search place" onChange={handleInput} name="destinationName"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg d-flex">
                        <div className="form-group p-4 border-0">
                            ...
                            <div className="form-field">
                                ...
                                <input type="text" className="form-control" placeholder="Search place" onChange={handleInput} name="destinationLocation"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg d-flex">
                        <div className="form-group d-flex w-100 border-0">
                            <div className="form-field w-100 align-items-center d-flex">
                                <input type="button" value="Search"
                                    className="align-self-stretch form-control btn btn-primary p-0" onClick={() => SearchDestination()} />
                            </div>
                        </div>
                    </div>
                </div>
